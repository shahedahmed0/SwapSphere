          ...
          return (
            ...
            <div className="card h-100 swap-card">
                ...
                <div className="card-body d-flex flex-column">
                  ...
                  {Array.isArray(it.conditionChecklist) && it.conditionChecklist.length > 0 &&
                  <div className="mb-2">
                      <p className="small text-muted mb-1">Condition checklist:</p>
                      <div className="d-flex flex-wrap gap-1">
                        {it.conditionChecklist.map((check, idx) =>
                      <span key={`${it._id}-check-${idx}`} className="badge text-bg-light border">
                            {check}
                          </span>
                      )}
                      </div>
