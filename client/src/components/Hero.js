      ...
      <div id="hero-carousel" className="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000" tabIndex="0">
        ...
        <div className="carousel-item active">
          ...
          <div className="carousel-container">
            ...
            <Link to="/create-listing" className="btn-get-started">Start Swapping</Link>
          </div>
        </div>
        ...
        <div className="carousel-item">
          ...
          <div className="carousel-container">
            ...
            <Link to="/marketplace" className="btn-get-started">Explore Marketplace</Link>
          </div>
        </div>
        ...
        <div className="carousel-item">
          ...
          <div className="carousel-container">
            ...
            <Link to="/safety" className="btn-get-started">Safety First</Link>
          </div>
        </div>
